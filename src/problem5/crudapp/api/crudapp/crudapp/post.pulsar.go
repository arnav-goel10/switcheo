...
func init() {
	...
	md_Post = File_crudapp_crudapp_post_proto.Messages().ByName("Post")
...
func (x *Post) slowProtoReflect() protoreflect.Message {
	mi := &file_crudapp_crudapp_post_proto_msgTypes[0]
...
func (x *fastReflection_Post) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "crudapp.crudapp.Post.title":
		return x.Title != ""
	case "crudapp.crudapp.Post.body":
		return x.Body != ""
	case "crudapp.crudapp.Post.creator":
		return x.Creator != ""
	case "crudapp.crudapp.Post.id":
		return x.Id != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: crudapp.crudapp.Post"))
		}
		panic(fmt.Errorf("message crudapp.crudapp.Post does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Post) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message crudapp.crudapp.Post does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Post) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "crudapp.crudapp.Post.title":
		panic(fmt.Errorf("field title of message crudapp.crudapp.Post is not mutable"))
	case "crudapp.crudapp.Post.body":
		panic(fmt.Errorf("field body of message crudapp.crudapp.Post is not mutable"))
	case "crudapp.crudapp.Post.creator":
		panic(fmt.Errorf("field creator of message crudapp.crudapp.Post is not mutable"))
	case "crudapp.crudapp.Post.id":
		panic(fmt.Errorf("field id of message crudapp.crudapp.Post is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: crudapp.crudapp.Post"))
		}
...
func (x *fastReflection_Post) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in crudapp.crudapp.Post", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Post) Descriptor() ([]byte, []int) {
	return file_crudapp_crudapp_post_proto_rawDescGZIP(), []int{0}
}
...
var File_crudapp_crudapp_post_proto protoreflect.FileDescriptor

var file_crudapp_crudapp_post_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x63, 0x72, 0x75, 0x64, 0x61, 0x70, 0x70, 0x2f, 0x63, 0x72, 0x75, 0x64, 0x61, 0x70,
	0x70, 0x2f, 0x70, 0x6f, 0x73, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0f, 0x63, 0x72,
	0x75, 0x64, 0x61, 0x70, 0x70, 0x2e, 0x63, 0x72, 0x75, 0x64, 0x61, 0x70, 0x70, 0x22, 0x5a, 0x0a,
	...
	,
}

var (
	file_crudapp_crudapp_post_proto_rawDescOnce sync.Once
	file_crudapp_crudapp_post_proto_rawDescData = file_crudapp_crudapp_post_proto_rawDesc
)

func file_crudapp_crudapp_post_proto_rawDescGZIP() []byte {
	file_crudapp_crudapp_post_proto_rawDescOnce.Do(func() {
		file_crudapp_crudapp_post_proto_rawDescData = protoimpl.X.CompressGZIP(file_crudapp_crudapp_post_proto_rawDescData)
	})
	return file_crudapp_crudapp_post_proto_rawDescData
}

var file_crudapp_crudapp_post_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_crudapp_crudapp_post_proto_goTypes = []interface{}{
	(*Post)(nil), // 0: crudapp.crudapp.Post
}
var file_crudapp_crudapp_post_proto_depIdxs = []int32{
...
func init() { file_crudapp_crudapp_post_proto_init() }
func file_crudapp_crudapp_post_proto_init() {
	if File_crudapp_crudapp_post_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_crudapp_crudapp_post_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Post); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_crudapp_crudapp_post_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_crudapp_crudapp_post_proto_goTypes,
		DependencyIndexes: file_crudapp_crudapp_post_proto_depIdxs,
		MessageInfos:      file_crudapp_crudapp_post_proto_msgTypes,
	}.Build()
	File_crudapp_crudapp_post_proto = out.File
	file_crudapp_crudapp_post_proto_rawDesc = nil
	file_crudapp_crudapp_post_proto_goTypes = nil
	file_crudapp_crudapp_post_proto_depIdxs = nil
}
