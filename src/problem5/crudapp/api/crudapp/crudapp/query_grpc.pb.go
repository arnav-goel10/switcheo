...
const (
	Query_Params_FullMethodName   = "/crudapp.crudapp.Query/Params"
	Query_ShowPost_FullMethodName = "/crudapp.crudapp.Query/ShowPost"
	Query_ListPost_FullMethodName = "/crudapp.crudapp.Query/ListPost"
)
