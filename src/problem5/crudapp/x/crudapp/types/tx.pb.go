...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_8fd02ff7f616a2af, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_8fd02ff7f616a2af, []int{1}
}
...
func (*MsgCreatePost) Descriptor() ([]byte, []int) {
	return fileDescriptor_8fd02ff7f616a2af, []int{2}
}
...
func (*MsgCreatePostResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_8fd02ff7f616a2af, []int{3}
}
...
func (*MsgUpdatePost) Descriptor() ([]byte, []int) {
	return fileDescriptor_8fd02ff7f616a2af, []int{4}
}
...
func (*MsgUpdatePostResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_8fd02ff7f616a2af, []int{5}
}
...
func (*MsgDeletePost) Descriptor() ([]byte, []int) {
	return fileDescriptor_8fd02ff7f616a2af, []int{6}
}
...
func (*MsgDeletePostResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_8fd02ff7f616a2af, []int{7}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "crudapp.crudapp.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "crudapp.crudapp.MsgUpdateParamsResponse")
	proto.RegisterType((*MsgCreatePost)(nil), "crudapp.crudapp.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "crudapp.crudapp.MsgCreatePostResponse")
	proto.RegisterType((*MsgUpdatePost)(nil), "crudapp.crudapp.MsgUpdatePost")
	proto.RegisterType((*MsgUpdatePostResponse)(nil), "crudapp.crudapp.MsgUpdatePostResponse")
	proto.RegisterType((*MsgDeletePost)(nil), "crudapp.crudapp.MsgDeletePost")
	proto.RegisterType((*MsgDeletePostResponse)(nil), "crudapp.crudapp.MsgDeletePostResponse")
}

func init() { proto.RegisterFile("crudapp/crudapp/tx.proto", fileDescriptor_8fd02ff7f616a2af) }

var fileDescriptor_8fd02ff7f616a2af = []byte{
	...
	0xff, 0x47, 0x7c, 0xd4, 0x57, 0xa1, 0x04, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/crudapp.crudapp.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/crudapp.crudapp.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdatePost(ctx context.Context, in *MsgUpdatePost, opts ...grpc.CallOption) (*MsgUpdatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/crudapp.crudapp.Msg/UpdatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeletePost(ctx context.Context, in *MsgDeletePost, opts ...grpc.CallOption) (*MsgDeletePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/crudapp.crudapp.Msg/DeletePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/crudapp.crudapp.Msg/UpdateParams",
	}
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/crudapp.crudapp.Msg/CreatePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/crudapp.crudapp.Msg/UpdatePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DeletePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/crudapp.crudapp.Msg/DeletePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "crudapp.crudapp.Msg",
	...
	Metadata: "crudapp/crudapp/tx.proto",
}
